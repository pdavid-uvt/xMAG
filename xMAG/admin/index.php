...
<head>
    ...
    <title>Setari administrator</title>
    ...
    <?php
        ...
        if(isset($_GET['loginsuccess']) && $_GET['loginsuccess']=="true"){
            echo '<div class="alert alert-success alert-dismissible fade show" role="alert" style="width:100%">
                    <strong>Conectarea s-a realizat cu succes!</strong> Acum aveti acces de tip 1 administrator.
...
<?php
        ...
        header("location: /xMAG/admin/login.php");
    }
?>