...
<body>
    ...
    <div class="container my-3">
        <h2 class="py-2">Rezultatele căutării pentru <em>"<?php echo $_GET['search']?>"</em> :</h2>
            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                echo '<div class="col-xs-3 col-sm-3 col-md-3">
                    <div class="card" style="width: 18rem;">
                        <img src="img/card-'.$catId. '.jpg" class="card-img-top" alt="Imagine pentru produs" width="249px" height="270px">
                        <div class="card-body">
                            <h5 class="card-title"><a href="viewPhoneList.php?catid=' . $catId . '">' . $catname . '</a></h5>
                            <p class="card-text">' . substr($catdesc, 0, 29). '...</p>
                            <a href="viewPhoneList.php?catid=' . $catId . '" class="btn btn-primary">Vezi mai multe</a>
                        </div>
                    </div>
                </div>';
            }
    ...
    <div class="container my-3" id="cont">
        ...
        <?php 
            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                echo '<div class="col-xs-3 col-sm-3 col-md-3">
                    <div class="card" style="width: 18rem;">
                        <img src="img/phone-'.$phoneId. '.jpg" class="card-img-top" alt="Imagine pentru produs" width="249px" height="270px">
                        <div class="card-body">
                            <h5 class="card-title">' . substr($phoneName, 0, 20). '...</h5>
                            <h6 style="color: #ff0000"> '.$phonePrice. ' RON</h6>
                            <p class="card-text">' . substr($phoneModel, 0, 29). '...</p>
                            <div class="row justify-content-center">';
                                ...
                                echo '</form>
                                <a href="viewPhone.php?phoneid=' . $phoneId . '"><button class="btn btn-primary">Detalii</button></a>
                            </div>
                        </div>
                    </div>
                </div>';
            ...
            if($noResult) {
                echo '<div class="jumbotron jumbotron-fluid">
                    <div class="container">
                        <h1>Pentru căutarea <em>"' .$_GET['search']. '"</em> nu a fost găsit niciun rezultat!</h1>
